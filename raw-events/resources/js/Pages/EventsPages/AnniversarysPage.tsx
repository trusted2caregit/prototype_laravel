...
const AnniversarysPage = () => {
  return (
    <div className="App">
 
      <Intro titleText='"Annivers Premium Fun Casino Entertainment | Casino Casino Casino Ltd"' isH1={true} buttonLink='#' buttonText='Read About Us'>
...
export default AnniversarysPage;
