...
const Home = () => {
  return (
    <div className="App">
      ...
      <p>From fun casino nights and <Link to="/magic_mirror">selfie mirrors</Link> to <Link to="/led_dancefloors">dazzling dancefloors</Link> and <Link to="/themed_nights">themed experiences</Link>, we strive to exceed expectations and create lasting memories for <Link to="/weddings">weddings</Link>, <Link to="/birthdays">milestone birthdays</Link>, <Link to="/charity_nights">charity events</Link>, <Link to="/corporate">corporate gatherings</Link>, and more.</p>
